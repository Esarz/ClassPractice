...
desktops.clickWriteNameReview(reviewInfo.get(0).get("Esar"));
desktops.clickYourReview(reviewInfo.get(0).get("This is my review here and I am writing this because I have to test my Cucumber Skills"));
