...
public class DesktopPage extends Base {
	...
	@FindBy(xpath ="//button[@id='button-review']")
	private WebElement ThankYouMessage; public boolean retailWebsiteDisplayed() {
	...
	writeNameReview.sendKeys("Esar"); //comes under common stepDef
	}
	public void clickYourReview(String review) {
	yourReview.sendKeys("This is my review here and I am writing this because I have to test my Cucumber Skills");//comes under common stepDef
	}
